...
if __name__ == '__main__':
    ...
    # Third experiment: Local steps homogenous case
    ...
    # Fourth experiment: Local steps heteregenous case
    number_round_fourth_experiment = number_round_third_experiment   
    epsilons_p_fourth =  0.0
    M_third_experiment = M_third_experiment
    #H_third =  [1, 10, 100]
    #step_third = [0.01, 0.001, 0.0001]
    #H_third =  [1, 10]
    #step_third = [0.3, 0.3]
    ...
    if args.experiment ==1: # Speedup homogenous case
        ...
        legend_elements.append(Line2D([0],[0], color = colors[6],marker = 'x',label=r"$S-FedPG$".format(M_third_experiment)))
        legend_elements.append(Line2D([0],[0], color = colors[5],marker = 'o',label=r"$RS-FedPG$".format(M_third_experiment)))
        legend_elements.append(Line2D([0],[0], color = colors[7],marker = 's',label=r"$FedQ$".format(M_third_experiment)))
        plt.plot(average_vales_RegSoftFedPG, label = r"Reg-Soft-FedPG $\epsilon_p = {:.3g}$".format(M_third_experiment), marker = 'o',color = colors[5],markevery=(0.1, 0.3),
            markersize = 8, linewidth = 0.8)
        plt.plot(average_vales_SoftFedPG, label = r"Soft-FedPG$".format(M_third_experiment), marker = 'x', color = colors[6],markevery=(0.1, 0.35),
            markersize = 8, linewidth = 0.8)
        ...
        plt.fill_between(range(number_round_third_experiment), np.array(average_vales_SoftFedPG) - np.array(std_vales_SoftFedPG), np.array(average_vales_SoftFedPG) + np.array(std_vales_SoftFedPG),color = colors[6] ,alpha=0.3)
        plt.fill_between(range(number_round_third_experiment), np.array(average_vales_RegSoftFedPG) - np.array(std_vales_RegSoftFedPG), np.array(average_vales_RegSoftFedPG) + np.array(std_vales_RegSoftFedPG), color = colors[5] , alpha=0.3)
    ...
    elif args.experiment ==4: # comparaison fed q learning heterogenous
        counter_marker = -1
        legend_elements = []
        for M in M_first_experiment:
            counter_marker+=1
        ...
        if args.environment ==1:
            ...
            plt.savefig(save_plot_folder+ "synthetic_experiment_2.pdf", bbox_inches="tight")
"""
    elif args.experiment ==3: # Impact local steos homogenous case
        counter_marker = -1
        legend_elements = []
        for k in range (len(H_third)):
            counter_marker+=1
            average_values_SoftFedPG = []
            average_values_RegSoftFedPG = []
            average_values_BitRegSoftFedPG = []
            ...
            true_objective_BitRegSoftFedPG = np.zeros((runs, number_round_third_experiment))
            for run in range(runs):
                true_objective_SoftFedPG_file = read_folder1 + '/' + 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(0.0)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_RegSoftFedPG_file = read_folder2 + '/' 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(0.0)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_BitRegSoftFedPG_file = read_folder3 + '/' 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(0.0)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_SoftFedPG[run,:] = load_results_from_pickle(true_objective_SoftFedPG_file)
                true_objective_RegSoftFedPG[run,:] = load_results_from_pickle(true_objective_RegSoftFedPG_file)
                true_objective_BitRegSoftFedPG[run,:] = load_results_from_pickle(true_objective_BitRegSoftFedPG_file)
            smaller_vales_SoftFedPG.append(np.min(true_objective_SoftFedPG, axis=0))
            ...
            std_vales_RegSoftFedPG = np.std(true_objective_RegSoftFedPG, axis=0)
            std_vales_BitRegSoftFedPG = np.std(true_objective_BitRegSoftFedPG, axis=0)
            legend_elements.append(Line2D([0],[0], color = colors[counter_marker],label=r"$H = {:.3g}$".format(H_third[k])))
            plt.plot(average_vales_SoftFedPG, label = r"Soft-FedPG$".format(M_third_experiment), marker = 'x', color = colors[counter_marker], markevery=20,
                markersize = 8, linewidth = 0.8)
            plt.plot(average_vales_RegSoftFedPG, label = r"Reg-Soft-FedPG".format(M_third_experiment), marker = 'o',color = colors[counter_marker],markevery=20,
                markersize = 8, linewidth = 0.8)
            plt.plot(average_vales_BitRegSoftFedPG, label = r"Bit-Reg-Soft-FedPG".format(M_third_experiment), marker = 'v',color = colors[counter_marker],markevery=20,
                markersize = 8, linewidth = 0.8)
    ...
    elif args.experiment ==4: # Impact local steos heteregenous case
        counter_marker = -1
        legend_elements = []
        for k in range (len(H_third)):
            counter_marker+=1
            ...
            true_objective_BitRegSoftFedPG = np.zeros((runs, number_round_third_experiment))
            for run in range(runs):
                true_objective_SoftFedPG_file = read_folder1 + '/' + 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(epsilons_p_fourth)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_RegSoftFedPG_file = read_folder2 + '/' 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(epsilons_p_fourth)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_BitRegSoftFedPG_file = read_folder3 + '/' 'N_'+ str(M_third_experiment) +',R_'+ str(number_round_third_experiment) + ',H_'+ str(H_third[k]) + ',step_'+ str(step_third[k]) + ',ep_'+ str(epsilons_p_fourth)+ ',run_'+str(run) +',true_objective.pkl'
                true_objective_SoftFedPG[run,:] = load_results_from_pickle(true_objective_SoftFedPG_file)
                true_objective_RegSoftFedPG[run,:] = load_results_from_pickle(true_objective_RegSoftFedPG_file)
                true_objective_BitRegSoftFedPG[run,:] = load_results_from_pickle(true_objective_BitRegSoftFedPG_file)
            smaller_vales_SoftFedPG.append(np.min(true_objective_SoftFedPG, axis=0))
            ...
            std_vales_BitRegSoftFedPG = np.std(true_objective_BitRegSoftFedPG, axis=0)
            legend_elements.append(Line2D([0],[0], color = colors[counter_marker],label=r"$H = {:.3g}$".format(H_third[k])))
            plt.plot(average_vales_SoftFedPG, label = r"Soft-FedPG$".format(M_third_experiment), marker = 'x', color = colors[counter_marker], markevery=100,
                markersize = 8, linewidth = 0.8)
            plt.plot(average_vales_RegSoftFedPG, label = r"Reg-Soft-FedPG".format(M_third_experiment), marker = 'o',color = colors[counter_marker],markevery=100,
                markersize = 8, linewidth = 0.8)
            plt.plot(average_vales_BitRegSoftFedPG, label = r"Bit-Reg-Soft-FedPG".format(M_third_experiment), marker = 'v',color = colors[counter_marker],markevery=100,
                markersize = 8, linewidth = 0.8)
            plt.fill_between(range(number_round_third_experiment), np.array(average_vales_SoftFedPG) - np.array(std_vales_SoftFedPG), np.array(average_vales_SoftFedPG) + np.array(std_vales_SoftFedPG) ,color = colors[counter_marker] ,alpha=0.3)
            plt.fill_between(range(number_round_third_experiment), np.array(average_vales_RegSoftFedPG) - np.array(std_vales_RegSoftFedPG), np.array(average_vales_RegSoftFedPG) + np.array(std_vales_RegSoftFedPG), color = colors[counter_marker] , alpha=0.3)
            plt.fill_between(range(number_round_third_experiment), np.array(average_vales_BitRegSoftFedPG) - np.array(std_vales_BitRegSoftFedPG), np.array(average_vales_BitRegSoftFedPG) + np.array(std_vales_BitRegSoftFedPG), color = colors[counter_marker] , alpha=0.3)
        ...
        plt.tight_layout()
        if args.environment ==1:
            plt.savefig(save_plot_folder +"gridword_experiment_4.pdf", bbox_inches="tight")
        else:
            plt.savefig(save_plot_folder+ "synthetic_experiment_4.pdf", bbox_inches="tight")
"""